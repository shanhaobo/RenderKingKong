...
#   define WIZ_MPP_BRIDGE_COMBINE(X, Y)         WIZ_MPP_BRIDGE_COMBINE_1(X,Y)
#   define WIZ_MPP_BRIDGE_COMBINE_1(X, Y)   WIZ_MPP_BRIDGE_COMBINE_2(X,Y)
#   define WIZ_MPP_BRIDGE_COMBINE_2(X, Y)   WIZ_MPP_BRIDGE_COMBINE_3(X,Y)
#   define WIZ_MPP_BRIDGE_COMBINE_3(X, Y)         WIZ_MPP_BRIDGE_COMBINE_IMPL(X,Y)
